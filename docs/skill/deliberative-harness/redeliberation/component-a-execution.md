...
复用 deliberative-execution 的子Agent指令文件，启动子Agent时让其自行阅读：

- **执行agent指令**：`../deliberative-execution/executor.md`
- **审查agent指令**：`../deliberative-execution/reviewer.md`
...
```
请先阅读文件 ../deliberative-execution/executor.md 获取完整工作指令，然后按要求完成以下任务：
...
```
请先阅读文件 ../deliberative-execution/reviewer.md 获取完整工作指令，然后按要求完成以下任务：
