...
- **质量审查agent指令**：`./quality-reviewer.md`
- **质量质询agent指令**：`./quality-challenger.md`
...
```
请先阅读文件 ./quality-reviewer.md 获取完整工作指令，然后按要求完成以下任务：
...
```
请先阅读文件 ./quality-challenger.md 获取完整工作指令，然后按要求完成以下任务：
